...
}]).directive("uibTooltipPopup", function ($timeout) {
    return {
        replace: !0,
        scope: {content: "@", placement: "@", popupClass: "@", animation: "&", isOpen: "&"},
        // templateUrl: "uib/template/tooltip/tooltip-popup.html",
        /*The follow code is our defined*/
        template:
            '<div class="tooltip ng-isolate-scope top fade in" style="top: 56px; left: 853px;">\
                <div class="tooltip-arrow"></div>\
                <div class="tooltip-inner" ng-bind="content" style="overflow-y: scroll;"></div>\
                <i class="fa fa-files-o btn-copy" aria-hidden="true" ngclipboard data-clipboard-text="{{content}}" ng-click="btnCopy()"></i>\
				<div class="btn-copy-tips" ng-show="btnCopyTip">复制成功</div>\
            </div>',
        link: function(scope){
        	scope.btnCopyTip = false;
        	scope.btnCopy = function(){
        		scope.btnCopyTip = true;
        		$timeout(function(){
        			scope.btnCopyTip = false;
        		},500)
        	}
        }
        /*The over code is our defined*/
    }
